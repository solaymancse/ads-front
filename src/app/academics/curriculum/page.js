    ...
    return (
        <>
            <div className="my-[100px]">
                <SectionHeader title="Curriculum" description="I'm a paragraph. Click here to add your own text and edit me. It’s easy. Just click “Edit Text” or double click me to add your own content and make changes to the font."
            ...
            <div className="mb-[100px]">
                ...
                <div className="mt-[50px] bg-[#688DDC] py-20">
                    <MultipleContentPair
                        ...
                        imageLeft={false}
                        bg="bg-white"
                        childrenLeft={<div className="text-[#1d1d36] px-20">
                        ...
                        childrenRight={<div className="text-[#1d1d36] px-20">
                            <h1 className="text-[24px]">Math</h1>
                            <p className="text-[16px] font-extralight mb-8">I'm a paragraph. Click here to add your own text and edit me. Let your users get to know a little more about you</p>
                    ...
                    <MultipleContentPair
                        ...
                        imageLeft={true}
                        bg="bg-[#1D1D36]"
                        childrenLeft={<div className="text-[#fff] px-20">
                            <h1 className="text-[24px]">Math</h1>
                            <p className="text-[16px] font-extralight mb-8">I'm a paragraph. Click here to add your own text and edit me. Let your users get to know a little more about you</p>

                            <div className="bg-blue-500 hover:bg-white hover:border hover:border-black transition-all duration-300 ease-in-out  flex justify-center items-center h-[46px] w-[152px] font-extralight text-white text-center  hover:text-black mt-4">Learn More</div>
                        </div>}
                        childrenRight={<div className="text-[#fff] px-20">
                            <h1 className="text-[24px]">Math</h1>
                            <p className="text-[16px] font-extralight mb-8">I'm a paragraph. Click here to add your own text and edit me. Let your users get to know a little more about you</p>
